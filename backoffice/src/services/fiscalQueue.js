...
// (fiscal_jobs), а лёгкий "фискальный агент" (отдельный Node.js-процесс,
// см. /atol-agent) на месте опрашивает /api/fiscal/jobs/next, выполняет
// задание через официальный драйвер АТОЛ ДТО10 и репортит результат обратно.
//
